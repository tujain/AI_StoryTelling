...
# from text_autoencoder.utils import set_seed, average_gradients, boolean_string
from autoencoder import DistributedBucketingDataLoader, eval_model_loss
...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=300, help='number of epochs for train')
    parser.add_argument('--batch_size', type=int, default=256, help='batch size for training')
    parser.add_argument('--valid_size', type=int, default=256, help='size for validation set')   
    parser.add_argument('--lr_decay_interval', type=int, default=25,
    ...
    parser.add_argument("--train_pt_dir", type=str, default='./data-bin/dummy_data/parsed/train')
    parser.add_argument("--dev_pt_dir", type=str, default='./data-bin/dummy_data/parsed/dev')
    ...
    parser.add_argument('--exp_name', type=str, default='ae', help='experiment name')
    # noise
        ...
        for batch in tqdm.tqdm(train_dataloader, desc=f"training_epoch{epoch}"):
            ...
            if args.world_size == 1 or (dist.get_rank() == 0):
                ...
                if global_step % args.val_interval == -1 % args.val_interval:
                    ...
                    if global_step % args.save_interval == 0 or epoch % 2 == 0:
